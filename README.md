...
![Arduino UNO](https://wiki.keyestudio.com/File:Ks0001-20.png)
...
|[script](https://wiki.keyestudio.com/Ks0001_keyestudio_UNO_R3_BOARD)


###Módulo sensor de fotorresistor (LDR)

![LDR](https://docs.wokwi.com/parts/wokwi-photoresistor-sensor)
...
![Pantalla LCD](https://docs.wokwi.com/parts/wokwi-lcd1602)
...
Se trata de un sensor de temperatura y humedad compuesto que se conecta a un microcontrolador de 8 bits de alto rendimiento. Incluye una resistencia y un dispositivvo de temperatura NTC con sensación de humedad.
